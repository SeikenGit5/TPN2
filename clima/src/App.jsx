  ...
  return (
    <>
      <nav>
        ...
        <ul>
          <li>
            <a href="#" onClick={() => handleCityClick(cities.tucuman)}>
              Tucumán
            </a>
          </li>
          <li>
            <a href="#" onClick={() => handleCityClick(cities.salta)}>
              Salta
            </a>
          </li>
          <li>
            <a href="#" onClick={() => handleCityClick(cities.bs)}>
              Buenos Aires
            </a>
          </li>
        </ul>
      ...
      <article>
        {weatherData && (
          <div>
            ...
            <div className="icono">
              <img
                src={`${import.meta.env.BASE_URL}src/openweathermap/${weatherData.weather[0].icon}.svg`}
                alt="weather icon"
              />
            </div>
